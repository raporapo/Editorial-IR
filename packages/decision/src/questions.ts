...
export const METRIC_QUESTIONS: Record<EditorialMetric, ScoreRequest> = {
    ...
    levels: [
      {
        level: 0,
        label: 'nothing',
        description: 'Removing it changes nothing a viewer would notice.',
      },
      {
        level: 1,
        label: 'supporting',
        description: 'Pleasant texture, but the piece survives without it.',
      },
      {
        level: 2,
        label: 'informative',
        description: 'Carries something the viewer needs to follow what happens.',
      },
      {
        level: 3,
        label: 'significant',
        description: 'A turning point; the piece reads differently without it.',
      },
  ...
  emotional_intensity: {
    ...
    question:
      'How strongly is feeling expressed in this moment itself, regardless of its importance?',
    levels: [
      ...
      { level: 2, label: 'clear', description: 'Feeling is plainly visible or audible.' },
      {
        level: 3,
        label: 'strong',
        description: 'Laughter, delight, distress; it carries the moment.',
      },
    ...
    levels: [
      {
        level: 0,
        label: 'unrelated',
        description: 'Nothing to do with the stated occasion or goal.',
      },
      {
        level: 1,
        label: 'incidental',
        description: 'Happens to be in the material, but serves nothing stated.',
      },
      {
        level: 2,
        label: 'relevant',
        description: 'Fits the occasion and the tone that was asked for.',
      },
      { level: 3, label: 'on_point', description: 'Directly serves the stated goal.' },
      {
        level: 4,
        label: 'defining',
        description: 'This is the sort of moment the user made the piece for.',
      },
    ],
  },
  visual_quality: {
    ...
    levels: [
      {
        level: 0,
        label: 'unusable',
        description: 'Out of focus, blown out, black, or a whip pan.',
      },
    ...
    levels: [
      {
        level: 0,
        label: 'unusable',
        description: 'Clipped, drowned in wind or noise, or silent when it should not be.',
      },
    ...
    levels: [
      {
        level: 0,
        label: 'repeat',
        description: 'Another event covers the same thing as well or better.',
      },
      {
        level: 1,
        label: 'similar',
        description: 'Close to other material, with small differences.',
      },
    ...
    levels: [
      {
        level: 0,
        label: 'jarring',
        description: 'Cutting into it from the previous event would jump badly.',
      },
      {
        level: 1,
        label: 'rough',
        description: 'Noticeably disconnected in place, subject or sound.',
      },
    ...
    levels: [
      {
        level: 0,
        label: 'none',
        description: 'Nothing is being said or shown that the viewer did not have.',
      },
      { level: 1, label: 'sparse', description: 'A little, spread thinly.' },
      {
        level: 2,
        label: 'steady',
        description: 'A normal conversational pace of new information.',
      },
